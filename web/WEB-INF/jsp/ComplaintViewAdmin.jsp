...
<input type="submit" value="Status Update!"type="submit" class="btn btn-default" style="background-color: #EC5844">
</form>
           
                      <form action="forward.htm">
<input type="submit" value="Forward to"type="submit" class="btn btn-default" style="background-color: #EC5844">
</form>
