...
<!--//end-slider-->
  ...
  <div class="col-md-10"><br><br><br>
        <h1 style="position: center;">Fowarding Complaint : ${lst.getCid()} Department : ${lst.getDepartment().getDname()}</h1>
                          </br>
  </div></div>
  ...
  <div class="col-md-4"><br><br><br>
      <form action="ForwardUpdated.htm">
  <div class="form-group">
    <select name="forward1">
        ...
        <input type="submit" class="btn btn-default" style="background-color: #EC5844" value="Forward to!">
  </div>
