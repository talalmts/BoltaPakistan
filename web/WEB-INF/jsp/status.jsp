...
<!--//end-slider-->
  ...
  <div class="col-md-10"><br><br><br>
      <h1 style="position: center;">Upadating Complaint : ${lst.getCid()} Department : ${lst.getDepartment().getDname()}</h1>
      <br><br>
  ...
  <div class="form-group">
   <select name="status1">
        ...
        <input type="submit" class="btn btn-default" style="background-color: #EC5844" value="Update">
  </div>
