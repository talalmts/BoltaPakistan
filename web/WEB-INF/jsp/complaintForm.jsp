...
<div class="row">
  ...
  <div class="col-md-4"><h1>Launch a Complain</h1></div>
...
<div class="row">
  ...
  <div class="col-md-8"><br><br><form method="post" action="sendcomplaint.htm" enctype="multipart/form-data">
...
<option value="Police">Police</option>
    ...
    <textarea class="form-control" name="desc"  maxlength="250">
</textarea>
          </div>
    ...
    <input  type="file"  name="file" id="file"  accept="image/*" >
          ...
          <div class="form-group">
    <input class="form-control" type="text" id="latFld" name="lat">
    <input class="form-control" type="text" id="lngFld" name="lng">
