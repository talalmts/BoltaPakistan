...
<!--//end-slider-->
	<!--start-services-->
        <div class="row">
            ...
            <div class="col-md-4"><br><br><h1>Admin Login</h1></div>
  <div class="col-md-4"></div>
        </div>
        <div class="row">
  <div class="col-md-4"></div>
  
  <div class="col-md-2"><br><br><br><br><br><form action="login.htm">
  <div class="form-group">
    <label for="exampleInputEmail1">Email address</label>
    <input type="text" class="form-control" id="exampleInputEmail1" name="FirstName" placeholder="Enter email">
  </div>
  <div class="form-group">
    ...
    <input type="password" class="form-control" id="exampleInputPassword1" name="password1" placeholder="Password">
          ...
          <button type="submit" class="btn btn-default" style="background-color: #EC5844">Submit</button>
